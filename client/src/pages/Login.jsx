            ...
            <section className="text-black-900 body-font ">
                <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
                    ...
                    <div className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 text-black-900">
                        <h2 className="text-green-500 text-lg font-bold title-font mb-5">Sign in</h2>
                        ...
                        <button className="inline-flex justify-center items-center text-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-white-100 font-extrabold rounded text-base mt-4 md:mt-0" onClick={handleSubmit}>Login
                            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="5" className="w-3 h-3 ml-0.4" viewBox="0 0 24 24">
                                <path d="M5 12h14M12 5l7 7-7 7"></path>
                            </svg>
                        </button>
                        <div id="msg" className="text-xs text-red-900 mt-3 text-center"></div>
                        <NavLink to="/register" className="text-xs text-gray-900 mt-3 text-center">Create Account</NavLink>
                    </div>
                </div>
            </section>
        </CTALayout>
