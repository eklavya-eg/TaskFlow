                    ...
                    <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
                        ...
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <NavLink to="/" className="nav-link active" aria-current="page" href="#">Stats</NavLink>
                            </li>
                            <li className="nav-item">
                                <NavLink to="/tasks" className="nav-link active" aria-current="page" href="#">Tasks</NavLink>
                            </li>
                            <li className="nav-item">
